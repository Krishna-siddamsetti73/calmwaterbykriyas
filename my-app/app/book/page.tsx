...
const services = [
  {
    id: "depression",
    label: "Depression Counselling",
    category: "Mental Health",
    price: 1200,
  },
  {
    id: "anxiety",
    label: "Anxiety Counselling",
    category: "Mental Health",
    price: 1200,
  },
  {
    ...
    <>
      ...
      <div className="book-page">
        ...
        >
          ...
          <p style={{ color: T.textSoft, fontSize: "1rem" }}>
                  ...
                  {i < STEPS.length - 1 && (
                    <div
                      style={{
                        flex: 1,
                        height: 1,
                        background: done ? T.accentDark + "55" : T.border,
                        margin: "0 8px",
                        marginBottom: 18,
                      }}
                    />
        ...
        {/* ── Step Content ── */}
        <div
          style={{ maxWidth: 780, margin: "0 auto", padding: "52px 24px 80px" }}
        >
          ...
          {step === 1 && (
            <div>
              <h2
                className="display"
                style={{ fontSize: "2rem", fontWeight: 300, marginBottom: 8 }}
              >
              ...
              >
                Choose the area you'd like support with.
              </p>
                      ...
                      {services
                        ...
                        .map((s) => (
                          ...
                          >
                            ...
                            <p
                              style={{ fontSize: "0.78rem", color: T.textSoft }}
                            >
                              ₹{s.price.toLocaleString("en-IN")} · 50 min
                            </p>
                          </div>
                        ))}
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: "0.77rem", color: T.textSoft }}>
                          {c.title}
                        </p>
                      </div>
                    </div>
          ...
          {step === 3 && (
            <div>
              ...
              >
                Mornings, evenings, weekends — your pace.
              </p>
              ...
              >
                Greyed slots are unavailable. All times in IST.
              </p>
            </div>
          )}
          ...
          {step === 4 && (
            <div>
              ...
              >
                So we can send your confirmation and reminder.
              </p>
              <div
                style={{
                  display: "flex",
          ...
          {step === 5 && (
            <div>
              ...
              >
                A gentle confirmation arrives in your inbox after payment.
              </p>
              ...
              >
                ...
                >
                  ...
                  >
                    ₹{(svc?.price ?? 1200).toLocaleString("en-IN")}
                  </span>
                </div>
              </div>
              ...
              >
                Payments are processed securely via Razorpay. You can reschedule
                or cancel anytime — without explanation.
              </p>
              ...
              >
                {paying
                  ? "Opening payment…"
                  : `Pay ₹${(svc?.price ?? 1200).toLocaleString("en-IN")}`}
          ...
          {step === 6 && paid && (
            <div style={{ textAlign: "center", paddingTop: 24 }}>
              ...
              >
                A confirmation has been sent to <strong>{email}</strong>. We
              ...
              >
                {[
                  ...
                  <div key={k} className="summary-row">
                    <span style={{ color: T.textSoft, fontSize: "0.82rem" }}>
                      {k}
                    </span>
