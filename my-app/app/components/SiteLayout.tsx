...
export function SiteLayout({ children }: SiteLayoutProps) {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col bg-background text-foreground ${pageClass}`}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid md:grid-cols-4 gap-10 text-sm">
        <div className="md:col-span-2">
          ...
          <p className="text-muted-foreground max-w-sm leading-relaxed">
            A quiet space for emotional clarity. We listen, we understand, we
            walk with you — at your own pace.
          </p>
        </div>
