...
export default function Contact() {
  ...
  return (
    <div className="pt-32 min-h-screen relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-mint-soft blur-3xl animate-breathe"
        style={{ animationDelay: "2s" }}
      />

      <section className="relative px-6 md:px-10 py-24 max-w-3xl mx-auto">
        <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-6 reveal">
          Safe space
        </p>
        <h1 className="reveal-blur font-display text-5xl md:text-7xl tracking-tight">
          Talk to us.
        </h1>
        <p
          className="reveal mt-6 text-lg text-muted-foreground max-w-xl"
          data-delay="200"
        >
          We're here to listen whenever you're ready. We'll respond with care
          and confidentiality.
        </p>
