...
export default function Lab() {
  return (
    <div
      style={{
        background:
          "linear-gradient(160deg, #081820 0%, #0f2027 35%, #0a1f1a 65%, #081820 100%)",
        minHeight: "100vh",
        overflowX: "hidden",
    ...
    >
      ...
      >
        ...
        />
        <div
          className="animate-blob anim-delay-2000"
          style={{
            position: "absolute",
            bottom: "-10%",
            left: "-10%",
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(123,111,160,0.15) 0%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
          className="animate-blob anim-delay-4000"
          style={{
            position: "absolute",
            top: "40%",
            left: "30%",
        ...
        />
        <div
          className="animate-blob anim-delay-600"
          style={{
            position: "absolute",
            top: "65%",
            right: "15%",
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(95,168,160,0.16) 0%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
  ...
  return (
    <div style={{ width: "100%", overflow: "hidden", lineHeight: 0 }}>
      ...
      >
        ...
        />
        <path
          d="M1200,30 C1350,60 1550,0 1800,30 C2050,60 2250,0 2400,30 L2400,60 L1200,60 Z"
          fill={color}
        />
      </svg>
    </div>
...
function HeroSection() {
  const pills = [
    {
      label: "Breathe",
      color: "rgba(143,173,148,0.25)",
      border: "rgba(143,173,148,0.5)",
      text: "#a8c9ae",
    },
    {
      label: "Release",
      color: "rgba(123,111,160,0.25)",
      border: "rgba(123,111,160,0.5)",
      text: "#b0a8d4",
    },
    {
      label: "Focus",
      color: "rgba(196,149,106,0.25)",
      border: "rgba(196,149,106,0.5)",
      text: "#d4b08a",
    },
    {
      label: "Listen",
      color: "rgba(184,205,212,0.25)",
      border: "rgba(184,205,212,0.5)",
      text: "#a8c9d4",
    },
    {
      label: "Garden",
      color: "rgba(143,173,148,0.25)",
      border: "rgba(74,124,89,0.5)",
      text: "#7bc491",
    },
    {
      label: "Gratitude",
    ...
    {
      label: "Body",
      color: "rgba(184,205,212,0.2)",
      border: "rgba(184,205,212,0.4)",
      text: "#b8cdd4",
    },
  ];
  ...
  return (
    <section
      style={{ padding: "120px 40px 0", maxWidth: 1100, margin: "0 auto" }}
    >
      ...
      <p
        style={{
          ...
          fontSize: 18,
          lineHeight: 1.8,
          color: "rgba(185,210,195,0.75)",
          maxWidth: 520,
          margin: "0 0 48px",
          fontWeight: 300,
        }}
        className="animate-fadeUp anim-delay-400"
      >
        Seven practices designed to help you breathe, release, focus, and return
        to peace. No login. No measurement. Just presence.
      </p>

      <div
        style={{ display: "flex", flexWrap: "wrap", gap: 10, opacity: 0 }}
        className="animate-fadeUp anim-delay-600"
      >
        {pills.map((p) => (
          <span
            key={p.label}
      ...
      <div
        style={{ marginTop: 64, opacity: 0 }}
        className="animate-fadeIn anim-delay-600"
      >
...
function Breathing() {
  ...
  const phaseColor: Record<string, string> = {
    Inhale: "rgba(143,173,148,",
    Hold: "rgba(184,205,212,",
    Exhale: "rgba(123,111,160,",
  };
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="Box breathing: 4-4-4. Proven to calm your nervous system in minutes."
        color="rgba(143,173,148,0.8)"
      />
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              height: size + 80,
              borderRadius: "50%",
              background: `radial-gradient(circle, ${c}0.25) 0%, transparent 70%)`,
              filter: "blur(30px)",
        ...
        <div style={{ display: "flex", gap: 40 }}>
          {[
            { label: "Inhale", dur: "4s", c: "rgba(143,173,148,0.9)" },
            { label: "Hold", dur: "4s", c: "rgba(184,205,212,0.9)" },
            { label: "Exhale", dur: "4s", c: "rgba(123,111,160,0.9)" },
          ].map((b) => (
            <div key={b.label} style={{ textAlign: "center" }}>
              <div
                className="serif"
                style={{ fontSize: 28, color: b.c, fontWeight: 300 }}
              >
                {b.dur}
              </div>
              <div
        ...
        {cycles > 0 && (
          <div
            style={{
              padding: "10px 24px",
              borderRadius: 50,
              background: "rgba(143,173,148,0.1)",
              border: "1px solid rgba(143,173,148,0.2)",
              fontSize: 13,
              color: "rgba(143,173,148,0.8)",
            }}
          >
  ...
  return (
    <section
      style={{
        ...
        borderTop: "1px solid rgba(255,255,255,0.06)",
        background:
          "linear-gradient(135deg, rgba(123,111,160,0.05) 0%, rgba(196,149,106,0.05) 100%)",
      }}
    >
      <SectionHeader
        eyebrow="02 — Release"
        title="Write it. Let it go."
        subtitle="Name what's weighing on you, then watch it dissolve."
        color="rgba(123,111,160,0.8)"
      />

      <div
        style={{ maxWidth: 640, margin: "48px auto 0", position: "relative" }}
      >
        ...
        {particles.map((p) => (
          <div
            ...
            style={{
              ...
              animation: "bubbleRiseSmall 3s ease-out forwards",
              pointerEvents: "none",
              zIndex: 10,
            }}
          />
          ...
          <button
            ...
            style={{
              ...
              background: text.trim()
                ? "linear-gradient(135deg, rgba(123,111,160,0.6), rgba(196,149,106,0.5))"
                : "rgba(255,255,255,0.05)",
              border: "1px solid rgba(123,111,160,0.4)",
              color: text.trim()
                ? "rgba(235,245,238,0.95)"
                : "rgba(185,210,195,0.3)",
              fontSize: 14,
...
function MandalaFocus() {
  ...
  return (
    ...
    >
      <SectionHeader
        eyebrow="03 — Mandala"
        title="Draw your focus."
        subtitle="Symmetrical drawing activates bilateral brain stimulation — grounding you in the present moment."
      ...
      >
        ...
        >
          ...
          >
            ...
            <input
              ...
              style={{ accentColor: "#8fad94", width: 100 }}
            />
          </label>
          <label
            style={{
          ...
          >
            ...
            <input
              ...
              style={{ accentColor: `hsl(${hue},60%,60%)`, width: 100 }}
            />
          </label>
        </div>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          ...
          {strokes > 0 && (
            <span style={{ fontSize: 12, color: "rgba(185,210,195,0.4)" }}>
              {strokes} strokes
            </span>
          )}
        </div>
        <p
          style={{
            fontSize: 13,
            color: "rgba(185,210,195,0.4)",
            textAlign: "center",
            maxWidth: 360,
          }}
        >
          Click or touch and drag to paint. Each stroke mirrors itself —
          creating order from movement.
        </p>
      </div>
    </section>
  );
...
function GratitudeJar() {
  ...
  const colors = [
    "rgba(143,173,148,0.3)",
    "rgba(123,111,160,0.3)",
    "rgba(196,149,106,0.3)",
    "rgba(184,205,212,0.3)",
    "rgba(126,176,110,0.3)",
  ];
  ...
  return (
    <section
      style={{
        ...
        borderTop: "1px solid rgba(255,255,255,0.06)",
        background:
          "linear-gradient(135deg, rgba(196,149,106,0.04) 0%, rgba(143,173,148,0.04) 100%)",
      }}
    >
      <SectionHeader
        eyebrow="04 — Gratitude"
        title="Fill your jar."
        subtitle="Research shows 3 things daily rewires your brain toward positivity within 3 weeks."
        color="rgba(196,149,106,0.8)"
      />
      ...
      <div style={{ maxWidth: 680, margin: "48px auto 0" }}>
        ...
        >
          ...
          >
            ...
            <path
              d="M60 40 Q55 20 80 15 L140 15 Q165 20 160 40 L175 240 Q175 265 110 265 Q45 265 45 240 Z"
              fill="rgba(255,255,255,0.03)"
              stroke="rgba(196,149,106,0.3)"
              strokeWidth="1.5"
            />
            <path
              d="M75 15 L145 15 Q155 15 155 25 L155 35 L65 35 L65 25 Q65 15 75 15 Z"
            ...
            {jarBubbles.map((b, i) => (
              <span
                ...
                style={{
                  ...
                  animation: `bubbleRiseSmall ${b.dur}s ease-in-out ${b.delay}s infinite`,
                }}
              />
            ))}
          </div>
            ...
            {notes.slice(-12).map((n) => (
              <div
                ...
                style={{
                  ...
                  padding: "3px 6px",
                  fontSize: 9,
                  color: "rgba(235,245,238,0.8)",
                  animation:
                    animating === n.id ? "petalBloom 0.5s ease-out" : "none",
                  maxWidth: "100%",
        ...
        {notes.length > 0 && (
          ...
          >
            {notes.length} gratitude{notes.length > 1 ? "s" : ""} collected
            today
          </p>
        )}
      </div>
...
function GardenBed({
  ...
  history: { mood: string; time: string; color: string; emoji: string }[];
}) {
  return (
    <div
      style={{
        ...
        overflowX: "auto",
        background:
          "linear-gradient(180deg, transparent 0%, rgba(74,124,89,0.07) 65%, rgba(74,124,89,0.16) 100%)",
        borderRadius: 20,
        border: "1px solid rgba(143,173,148,0.15)",
      }}
    >
      {history.length === 0 && (
        <span
        ...
        >
          ...
          <div
            style={{
              width: 2,
              height: 30 + (i % 3) * 14,
              background: `linear-gradient(180deg, ${h.color}, rgba(74,124,89,0.35))`,
              borderRadius: 2,
            }}
          />
          <span
...
function MoodGarden() {
  ...
  const [history, setHistory] = useState<
    { mood: string; time: string; color: string; emoji: string }[]
  >([]);
  ...
  const select = (m: (typeof MOODS)[0]) => {
    ...
    setHistory((h) => [
      ...h.slice(-7),
      { mood: m.label, time, color: m.color, emoji: m.emoji },
    ]);
  };
  ...
  return (
    ...
    >
      <SectionHeader
        eyebrow="05 — Mood Garden"
        title="How are you right now?"
        subtitle="Naming your emotion reduces its intensity by up to 50% — it's called 'affect labeling'."
        color="rgba(143,173,148,0.8)"
      />
      ...
      >
            ...
            >
              ...
              <span
                style={{
                  fontSize: 11,
                  color:
                    selected === m.label ? m.color : "rgba(185,210,195,0.5)",
                  letterSpacing: "0.1em",
                  textTransform: "uppercase",
                }}
              >
        ...
        {selected && current && (
          ...
          >
            ...
            >
              Feeling <em style={{ color: current.color }}>{selected}</em> is
              valid.
            </p>
            <p
              style={{
...
function getMoodMessage(mood: string): string {
  const messages: Record<string, string> = {
    ...
    Happy:
      "Joy is contagious. Let yourself feel it fully without rushing past it.",
    Sad: "Sadness is a sign you care deeply. Be gentle with yourself today.",
    Angry:
      "Your anger carries information. Take three slow breaths before responding to anything.",
    Anxious:
      "Place both feet flat on the floor. Feel the ground beneath you. You are safe.",
    Tired:
      "Rest is not laziness — it's maintenance. Your body is asking for care.",
    Grateful:
      "Gratitude rewires your brain. You've already begun healing by noticing the good.",
    Strong:
      "Channel this energy with intention. You have more capacity than you realise.",
  };
  ...
  return (
    <section
      style={{
        ...
        borderTop: "1px solid rgba(255,255,255,0.06)",
        background:
          "linear-gradient(135deg, rgba(123,111,160,0.04) 0%, rgba(184,205,212,0.04) 100%)",
      }}
    >
      <SectionHeader
        eyebrow="06 — Focus"
        title="Bring the chaos to calm."
        subtitle="Each tap slows the noise. A metaphor for your mind — and a practice for your attention."
        color="rgba(123,111,160,0.8)"
      />
          ...
          >
            <div
              style={{
                ...
                width: `${calmLevel}%`,
                background:
                  "linear-gradient(90deg, rgba(123,111,160,0.7), rgba(143,173,148,0.7))",
                borderRadius: 4,
        ...
        {Array.from({ length: 16 }).map((_, i) => (
          <span
            ...
            style={{
              ...
              height: 18,
              background:
                "linear-gradient(180deg, rgba(184,205,212,0.7), transparent)",
...
function SoundSpace() {
  ...
  const sounds = [
    ...
    },
    {
      ...
      emoji: "🌊",
      desc: "Waves and tide",
      url: "/assets/ocean-waves-112906.mp3",
    ...
    },
    {
      ...
      label: "Forest",
      emoji: "🌲",
      desc: "Birds and breeze",
      url: "/assets/audiopapkin-forest-ambience-296528.mp3",
      color: "rgba(143,173,148,0.3)",
    },
    {
      id: "silence",
      label: "Silence",
      emoji: "🔇",
      desc: "Pure quiet",
      url: "/assets/h-beats-quite-bass-effect-265754.mp3",
      color: "rgba(123,111,160,0.3)",
    },
  ];
  ...
  return (
    ...
    >
      <SectionHeader
        eyebrow="07 — Sound Space"
        title="Listen. Relax."
        subtitle="Choose a soundscape and let it carry you somewhere still."
        color="rgba(184,205,212,0.8)"
      />
          ...
          {sounds.map((s) => (
            <button
              ...
              style={{
                ...
                textAlign: "left",
                background:
                  active === s.id ? s.color : "rgba(255,255,255,0.03)",
            ...
            >
              ...
              <div style={{ fontSize: 12, color: "rgba(185,210,195,0.5)" }}>
                {s.desc}
              </div>
              {active === s.id && (
                <div
                ...
                >
                  {[...Array(5)].map((_, i) => (
                    <div
                      ...
                      style={{
                        width: 3,
                        background: "rgba(184,205,212,0.7)",
                        borderRadius: 2,
        ...
        {active && (
          <div style={{ marginTop: 24 }}>
            ...
            <div style={{ textAlign: "center", marginTop: 16 }}>
              <button
                onClick={() => toggle(active, null)}
                style={{
                  padding: "10px 28px",
                  borderRadius: 50,
                  background: "rgba(184,205,212,0.1)",
                  border: "1px solid rgba(184,205,212,0.3)",
                  color: "rgba(168,201,212,0.8)",
                  fontSize: 13,
                  cursor: "pointer",
                }}
              >
...
const BODY_PARTS = [
  {
    ...
    label: "Head & Face",
    y: 8,
    msg: "Relax your forehead, jaw, and eyes. Let your tongue drop from the roof of your mouth.",
  },
  {
    id: "neck",
    label: "Neck & Shoulders",
    y: 22,
    msg: "Roll your shoulders down away from your ears. Release any tension you've been holding here.",
  },
  {
    id: "chest",
    label: "Chest & Heart",
    y: 35,
    msg: "Take one deep breath. Feel your chest rise and fall. Your heart is working for you.",
  },
  {
    id: "belly",
    label: "Belly",
    y: 50,
    msg: "Soften your stomach. You don't need to hold it in. Let it expand naturally.",
  },
  {
    id: "hips",
    label: "Hips & Lower Back",
    y: 62,
    msg: "Notice any tightness in your lower back or hips. Imagine it melting with each exhale.",
  },
  {
    id: "legs",
    label: "Legs",
    y: 76,
    msg: "Let your legs be heavy. You don't need to go anywhere right now.",
  },
  {
    id: "feet",
    label: "Feet",
    y: 90,
    msg: "Feel the ground beneath your feet. This is where you are. You are here. You are safe.",
  },
];
    ...
    >
      ...
      <g opacity="0.55">
        <ellipse
          ...
          rx="22"
          ry="26"
          fill="rgba(184,205,212,0.1)"
          stroke="rgba(184,205,212,0.3)"
          strokeWidth="1"
        />
        <path
          d="M50 70 Q80 58 110 70 L122 150 Q80 168 38 150 Z"
          fill="rgba(184,205,212,0.08)"
          stroke="rgba(184,205,212,0.25)"
          strokeWidth="1"
        />
        <path
          d="M44 150 Q80 165 116 150 L108 230 Q80 244 52 230 Z"
          fill="rgba(184,205,212,0.07)"
          stroke="rgba(184,205,212,0.2)"
          strokeWidth="1"
        />
        <path
          d="M52 230 Q80 244 108 230 L100 280 Q80 290 60 280 Z"
          fill="rgba(184,205,212,0.07)"
          stroke="rgba(184,205,212,0.2)"
          strokeWidth="1"
        />
        <path
          d="M62 280 L56 380 Q68 392 80 392 Q92 392 104 380 L98 280 Z"
          fill="rgba(184,205,212,0.06)"
          stroke="rgba(184,205,212,0.18)"
          strokeWidth="1"
        />
        <ellipse
          cx="64"
  ...
  return (
    <section
      style={{
        ...
        borderTop: "1px solid rgba(255,255,255,0.06)",
        background:
          "linear-gradient(135deg, rgba(184,205,212,0.04) 0%, rgba(74,124,89,0.04) 100%)",
      }}
    >
      <SectionHeader
        eyebrow="08 — Body Scan"
        title="Come back to your body."
        subtitle="A guided scan releases stored tension and reconnects mind to body — try the full sequence."
        color="rgba(184,205,212,0.8)"
      />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  textAlign: "left",
                  background: isActive
                    ? "rgba(184,205,212,0.12)"
                    : done
                      ? "rgba(143,173,148,0.06)"
                      : "rgba(255,255,255,0.03)",
              ...
              >
                <div
                  style={{
                    ...
                    background: done
                      ? "rgba(143,173,148,0.3)"
                      : "rgba(255,255,255,0.05)",
                    border: `1px solid ${done ? "rgba(143,173,148,0.5)" : "rgba(255,255,255,0.1)"}`,
                    fontSize: 10,
                    color: "rgba(143,173,148,0.8)",
                  }}
                >
                ...
                <span
                  style={{
                    fontSize: 14,
                    color: isActive
                      ? "rgba(184,205,212,0.95)"
                      : done
                        ? "rgba(185,210,195,0.7)"
                        : "rgba(185,210,195,0.5)",
                  }}
                >
                  {b.label}
                </span>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 50,
              background: autoPlay
                ? "rgba(184,205,212,0.2)"
                : "rgba(255,255,255,0.04)",
              border: `1px solid ${autoPlay ? "rgba(184,205,212,0.4)" : "rgba(255,255,255,0.1)"}`,
              color: "rgba(184,205,212,0.8)",
              fontSize: 12,
              cursor: "pointer",
              letterSpacing: "0.1em",
        ...
        <div style={{ position: "sticky", top: 40 }}>
          {current ? (
            <div
              style={{
                padding: "28px",
                background: "rgba(184,205,212,0.06)",
                border: "1px solid rgba(184,205,212,0.15)",
                borderRadius: 20,
              ...
              {autoPlay && (
                ...
                >
                  <div
                    ...
                    style={{
                      height: "100%",
                      background: "rgba(184,205,212,0.5)",
                      borderRadius: 3,
            ...
            >
              ...
              >
                Select a body region to focus your attention there, or start the
                guided sequence.
              </p>
            </div>
          )}
          ...
          {completed.size === BODY_PARTS.length && (
            <div
              style={{
                ...
                padding: "16px 20px",
                background: "rgba(143,173,148,0.1)",
                border: "1px solid rgba(143,173,148,0.25)",
                borderRadius: 16,
                textAlign: "center",
              }}
            >
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          These practices are always here. Visit whenever your mind needs rest,
          your heart needs healing, or your spirit needs grounding.
        </p>
        <button
          style={{
            padding: "16px 40px",
            borderRadius: 50,
            background:
              "linear-gradient(135deg, rgba(143,173,148,0.3), rgba(123,111,160,0.3))",
            border: "1px solid rgba(143,173,148,0.4)",
            color: "rgba(235,245,238,0.9)",
            fontSize: 15,
            cursor: "pointer",
            letterSpacing: "0.05em",
