...
const posts = [
  {
    ...
    excerpt:
      "Learn practical techniques to calm racing thoughts and find peace in quiet moments.",
  },
  {
    cat: "Relationships",
    ...
    excerpt:
      "Recognize the signs of burnout and build sustainable connections with others.",
  },
  {
    cat: "Personal growth",
    ...
    image:
      "https://images.unsplash.com/photo-1516321318423-f06f70504504?w=600&h=400&fit=crop",
    excerpt:
      "Discover how small, intentional boundaries create lasting positive change.",
  },
  {
    cat: "Mental health",
  ...
  },
  {
    ...
    time: "4 min",
    image:
      "https://images.unsplash.com/photo-1553531088-2353dda11fab?w=600&h=400&fit=crop",
    excerpt:
      "Embrace the journey of gradual transformation and sustainable growth.",
  },
];
    ...
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 min-h-screen">
      ...
      <section className="relative px-6 md:px-10 pt-20 pb-32 md:pt-32 md:pb-40 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in-up">
            <p
              className="text-xs uppercase tracking-[0.3em] text-slate-600 mb-6 opacity-0 animate-fadeInDown"
              style={{ animationDelay: "0.2s" }}
            >
              Welcome to Stillness
            </p>
            <h1
              className="font-serif text-5xl md:text-7xl tracking-tight text-slate-900 leading-tight mb-6 opacity-0 animate-fadeInDown"
              style={{ animationDelay: "0.4s" }}
            >
              Thoughts for a clearer mind.
            </h1>
            <p
              className="text-lg text-slate-600 leading-relaxed mb-8 max-w-lg opacity-0 animate-fadeInDown"
              style={{ animationDelay: "0.6s" }}
            >
              Explore insights on mental health, relationships, and personal
              growth. Therapy-inspired articles to help you navigate life with
              greater clarity and peace.
            </p>

            {/* Category Pills */}
            <div
              className="flex flex-wrap gap-3 opacity-0 animate-fadeInUp"
              style={{ animationDelay: "0.8s" }}
            >
              {["Mental health", "Relationships", "Personal growth"].map(
                (c) => (
                  <span
                    key={c}
          ...
          {/* Right Image Grid */}
          <div
            className="grid grid-cols-2 gap-4 opacity-0 animate-fadeInRight"
      ...
      <section className="px-6 md:px-10 py-24 max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <p className="text-slate-600 max-w-2xl">
            Discover thoughtfully crafted insights to support your mental
            wellness journey
          </p>
        </div>
      ...
      <section className="px-6 md:px-10 py-24 bg-gradient-to-r from-blue-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center text-white">
          <h2
            className="font-serif text-4xl md:text-5xl mb-6 opacity-0 animate-fadeInDown"
            style={{ animationDelay: "0.2s" }}
          >
            Ready to explore your thoughts?
          </h2>
          <p
            className="text-lg text-white/90 max-w-2xl mx-auto mb-10 opacity-0 animate-fadeInUp"
            style={{ animationDelay: "0.4s" }}
          >
            Subscribe to get weekly therapy insights delivered to your inbox,
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="border-l-4 border-emerald-600 pl-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Our thoughtfully curated articles help you name what you feel,
                notice patterns in your thoughts and behaviors, and carry
                greater clarity into your daily life. Each piece is designed to
                complement your therapeutic work.
              </p>
            </div>
          </div>
          ...
          >
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-2xl p-8 border border-blue-200">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-600 mb-6">
                Popular Themes
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700">
                    Managing overthinking and racing thoughts
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 font-bold text-lg mt-1">
