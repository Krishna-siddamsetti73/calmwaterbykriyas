...
const services: Service[] = [
  ...
  },
  {
    ...
    desc: "Manage worry, calm your mind, and build emotional strength.",
    slug: "anxiety",
    cat: "mental",
    img: "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Stress Management",
    desc: "Break overwhelming stress patterns and restore balance.",
    slug: "stress-management",
    cat: "mental",
    img: "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Overthinking & Negative Thoughts",
    desc: "Reduce mental overload and develop clarity in decisions.",
    slug: "overthinking",
    cat: "mental",
    img: "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=600&auto=format&fit=crop&q=80",
  },
  {
  ...
  },
  {
    ...
    desc: "Improve communication and strengthen emotional connection.",
    slug: "couple",
    cat: "relationship",
  ...
  },
  {
    ...
    desc: "Resolve conflicts and rebuild trust.",
    slug: "marriage",
    cat: "relationship",
    img: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Breakup & Divorce Counselling",
    desc: "Heal from emotional loss and rebuild confidence.",
    slug: "breakup",
    cat: "relationship",
    img: "https://images.unsplash.com/photo-1494774157365-9e04c6720e47?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Pre & Post Marriage Counselling",
    desc: "Prepare for a strong relationship and married life.",
    slug: "pre-post-marriage",
    cat: "relationship",
    img: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Domestic Violence Support",
    desc: "Safe space for healing, strength, and recovery.",
    slug: "domestic-violence",
    cat: "relationship",
    img: "https://images.unsplash.com/photo-1518398046578-8cca57782e17?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Career Counselling",
    desc: "Make confident career decisions aligned with your strengths.",
    slug: "career",
    cat: "career",
  ...
  },
  {
    ...
    desc: "Reconnect with purpose and take meaningful action.",
    slug: "motivation",
    cat: "career",
    img: "https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Time Management",
    desc: "Build structure and balance in your daily life.",
  ...
  },
  {
    ...
    desc: "Manage stress and improve overall well-being.",
    slug: "work-life-balance",
    cat: "career",
    img: "https://images.unsplash.com/photo-1483389127117-b6a2102724ae?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Adolescent Counselling",
    desc: "Support teenagers through emotional and academic challenges.",
    slug: "adolescent",
    cat: "family",
  ...
  },
  {
    ...
    desc: "Build confident and connected parenting skills.",
    slug: "parenting",
    cat: "family",
    img: "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Family Counselling",
    desc: "Improve communication and strengthen family relationships.",
    slug: "family",
    cat: "family",
    img: "https://images.unsplash.com/photo-1511895307984-ee87c1cf0bc6?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Learning & Academic Support",
    desc: "Help students improve focus, memory, and performance.",
    slug: "academic-support",
    cat: "family",
    img: "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Trauma & PTSD Counselling",
    desc: "Heal from past experiences and regain stability.",
    slug: "trauma",
    cat: "specialised",
    img: "https://images.unsplash.com/photo-1500964757637-c85e8a162699?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "ADHD Support",
    desc: "Improve focus, organization, and emotional regulation.",
    slug: "adhd",
    cat: "specialised",
  ...
  },
  {
    ...
    desc: "Process loss and find emotional healing.",
    slug: "grief",
    cat: "specialised",
    img: "https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "LGBTQIA+ Support",
    desc: "Safe, inclusive, and affirming counselling space.",
    slug: "lgbtq",
    cat: "specialised",
  ...
  },
  {
    ...
    desc: "Break dependency patterns and regain control.",
    slug: "addiction",
    cat: "specialised",
    img: "https://images.unsplash.com/photo-1518131672697-613becd4fab5?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Anger Management",
    desc: "Understand triggers and respond calmly and constructively.",
  ...
  },
  {
    ...
    desc: "Build grounding and regulation skills for intense moments.",
    slug: "panic-attack",
    cat: "emotional",
    img: "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Recognize early signs and manage emotional fluctuations.",
    slug: "bipolar",
    cat: "emotional",
    img: "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Rebuild self-worth and inner confidence.",
  ...
  },
  {
    ...
    desc: "Reframe self-critical thoughts into a balanced mindset.",
    slug: "negative-thinking",
    cat: "emotional",
  ...
  },
  {
    ...
    desc: "Replace unhelpful habits with healthier responses.",
    slug: "behavioural",
    cat: "emotional",
  ...
  },
  {
    ...
    desc: "Rebuild confidence, safety, and emotional resilience.",
    slug: "bullying",
    cat: "emotional",
    img: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Gradual, structured techniques to face and reduce fear.",
    slug: "phobia",
    cat: "emotional",
    img: "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "A confidential space for clarity, self-awareness, and growth.",
    slug: "individual",
    cat: "care",
    img: "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Build trust, empathy, and healthier relationship patterns.",
    slug: "couples",
    cat: "care",
    img: "https://images.unsplash.com/photo-1518621012420-8ab10887ea36?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Divorce Counselling",
    desc: "Navigate separation with clarity, healing, and stability.",
    slug: "divorce",
    cat: "care",
    img: "https://images.unsplash.com/photo-1494774157365-9e04c6720e47?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "A respectful space to address intimacy and sexual well-being.",
    slug: "sex-counselling",
    cat: "care",
    img: "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "PTSD Counselling",
    desc: "Process trauma and rebuild emotional stability.",
    slug: "ptsd",
    cat: "care",
    img: "https://images.unsplash.com/photo-1500964757637-c85e8a162699?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Immediate, judgment-free support during crisis.",
    slug: "suicidal-intervention",
    cat: "care",
    img: "https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=600&auto=format&fit=crop&q=80",
  },
  {
    title: "Psychodynamic Counselling",
    desc: "Understand deep emotional patterns rooted in the past.",
    slug: "psychodynamic",
    cat: "care",
    img: "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=600&auto=format&fit=crop&q=80",
  },
  ...
  },
  {
    ...
    desc: "Build a balanced, healthier relationship with food.",
  ...
  },
  {
    ...
    desc: "Understand your traits, patterns, and dynamics.",
    slug: "personality",
    cat: "care",
    img: "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Clarity on courses, learning pathways, and academic goals.",
    slug: "education",
    cat: "care",
    img: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Support through emotional, physical, and lifestyle changes.",
    slug: "menopause",
    cat: "care",
    img: "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=600&auto=format&fit=crop&q=80",
  },
  {
    ...
    desc: "Structured support for memory decline and caregivers.",
    slug: "dementia",
    cat: "care",
  ...
  },
  {
    ...
    desc: "Confidential workplace and personal well-being support.",
    slug: "eap",
    cat: "care",
    img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80",
  },
  ...
  return (
    ...
    >
      <svg
        ...
        height={size}
        viewBox="0 0 200 200"
        style={{ animation: "svc3-morph 12s ease-in-out infinite" }}
      >
        <defs>
          <radialGradient
            id={`og-${color.replace("#", "")}`}
  ...
  return (
    ...
    >
      <div
        style={{
          display: "flex",
          animation: "svc3-ticker 22s linear infinite",
          width: "max-content",
          gap: 0,
        }}
      >
      ...
      <div className="svc3-root">
        ...
        <section className="svc3-hero">
          ...
          <div className="svc3-hero-left">
            ...
            <MorphOrb
              color="#7C5CBF"
              size={340}
              style={{ top: -80, left: -100, zIndex: 0 }}
            />
            <MorphOrb
              color="#C05478"
              size={280}
            ...
            <div
              className="svc3-ring"
              style={{ width: 440, height: 440, animationDelay: "1.2s" }}
            />
            <div
              className="svc3-ring"
              style={{ width: 580, height: 580, animationDelay: "2.4s" }}
            />
            ...
            <div style={{ position: "relative", zIndex: 3 }}>
              ...
              <p className="svc3-hero-sub">
                Browse every counselling service we offer — from anxiety and
                grief to career clarity and family healing. One calm space, many
                paths forward.
              </p>

              <div className="svc3-hero-cta-row">
                <Link href="/book" className="svc3-hero-btn-primary">
                  Book a session
          ...
          <div className="svc3-hero-right">
            ...
            {/* Floating glass card */}
            <div
              className="svc3-hero-right-card"
        ...
        <div className="svc3-grid-section">
          ...
          >
            <p style={{ fontSize: "0.78rem", color: T.inkSoft }}>
              Showing{" "}
              <strong style={{ color: T.ink }}>{filtered.length}</strong>{" "}
          ...
          {filtered.length === 0 ? (
            <div style={{ textAlign: "center", padding: "100px 0" }}>
              ...
              <p
                className="display"
                style={{ fontSize: "1.6rem", fontWeight: 300, marginBottom: 8 }}
              >
                Nothing matches that search
              </p>
              <p style={{ color: T.inkSoft, fontSize: "0.88rem" }}>
            ...
            <div className="svc3-grid">
              {filtered.map((s, i) => {
                ...
                const catLabel =
                  categories.find((c) => c.key === s.cat)?.label ?? s.cat;
                return (
                  <Link
                    key={s.slug}
                    ...
                    ref={(el) => {
                      if (el) {
                        setTimeout(
                          () => el.classList.add("svc3-card-visible"),
                          (i % 12) * 50 + 60,
                        );
                      }
                    }}
        ...
        <section className="svc3-cta">
          <MorphOrb
            color="#7C5CBF"
            size={400}
            style={{ top: -100, left: "15%", opacity: 0.3 }}
          />
          <MorphOrb
            color="#2E917A"
            size={350}
          ...
          >
            ...
            <Reveal delay={160}>
              <Link href="/book" className="svc3-cta-btn">
                Book a session
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M5 12H19M19 12L12 5M19 12L12 19"
