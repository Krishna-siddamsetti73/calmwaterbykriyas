...
const base = {
  mental: {
    accent: "#b39ddb",
    accentBg: "#ede7f6",
    img: "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=1600&auto=format&fit=crop&q=80",
  },
  relationship: {
    accent: "#c0707a",
    accentBg: "#FADADD",
    img: "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=1600&auto=format&fit=crop&q=80",
  },
  career: {
    accent: "#5c9e8f",
    accentBg: "#e0f2ef",
    img: "https://images.unsplash.com/photo-1483389127117-b6a2102724ae?w=1600&auto=format&fit=crop&q=80",
  },
  family: {
    accent: "#c8924a",
    accentBg: "#fdf0e0",
    img: "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=1600&auto=format&fit=crop&q=80",
  },
  specialised: {
    accent: "#6a8fbf",
    accentBg: "#e8f1fb",
    img: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=1600&auto=format&fit=crop&q=80",
  },
  emotional: {
    accent: "#b4699c",
    accentBg: "#f8edf4",
    img: "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=1600&auto=format&fit=crop&q=80",
  },
  care: {
    accent: "#6e9558",
    accentBg: "#eff5ea",
    img: "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=1600&auto=format&fit=crop&q=80",
  },
};
...
const data: Record<string, ServiceData> = {
  ...
  depression: {
    ...
    intro:
      "Depression can feel heavy, isolating, and difficult to put into words. You are not alone in this — and you don't have to carry it alone either.",
    feel: [
      "Low energy and motivation",
      "Loss of interest in things you once loved",
      "Emotional fatigue",
      "A quiet sense of distance from yourself",
    ],
    help: [
      "A safe, judgment-free space to talk",
      "Practical coping techniques",
      "Help understanding triggers and patterns",
  ...
  anxiety: {
    ...
    intro:
      "Excessive worry and fear can quietly take over daily life. Counselling helps you understand it — and loosen its grip.",
    feel: [
      "Constant or racing worry",
  ...
  "stress-management": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Daily pressures build up quietly until they feel unmanageable. We help you find your footing again.",
    feel: [
      "Constant overwhelm",
    ...
    help: [
      ...
      "Better day-to-day emotional balance",
      "Sustainable routines, not quick fixes",
    ],
    outcome: "A calmer, steadier, more balanced life.",
    outcomeImg:
      "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1600&auto=format&fit=crop&q=80",
  },
  overthinking: {
    title: "Overthinking & Negative Thoughts",
    group: "Mental Health",
    ...base.mental,
    heroImg:
      "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Repetitive, overwhelming thoughts can cloud even simple decisions. We help quiet the noise and restore clarity.",
    feel: [
      "Racing or looping thoughts",
      "Difficulty deciding or moving forward",
  ...
  sleep: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1455642305367-68834a9d4337?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Restless nights affect everything that follows. We help you rebuild a healthier relationship with rest.",
    feel: [
    ...
    help: [
      ...
      "Building effective sleep habits",
  ...
  couple: {
    ...
    intro:
      "Every relationship faces friction. Counselling gives you both the space and tools to move through it together.",
    feel: [
    ...
    help: [
      ...
      "Tools for navigating life changes together",
    ],
    outcome: "A stronger, more balanced, more connected partnership.",
    outcomeImg:
      "https://images.unsplash.com/photo-1518621012420-8ab10887ea36?w=1600&auto=format&fit=crop&q=80",
  },
  marriage: {
    ...
    intro:
      "Marriage evolves — and so do its challenges. We help couples reconnect with clarity and mutual respect.",
    feel: [
  ...
  breakup: {
    title: "Breakup & Divorce Counselling",
    group: "Relationships",
    ...base.relationship,
    heroImg:
      "https://images.unsplash.com/photo-1494774157365-9e04c6720e47?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Endings carry real grief. We hold space for it — and help you find solid ground again.",
    feel: [
    ...
    help: [
      ...
      "Support making clear next decisions",
    ],
    outcome: "Renewed clarity, resilience, and inner strength.",
    outcomeImg:
      "https://images.unsplash.com/photo-1518398046578-8cca57782e17?w=1600&auto=format&fit=crop&q=80",
  },
  "pre-post-marriage": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Whether preparing for marriage or adjusting to its realities, we help you build a strong, lasting foundation.",
    feel: [
      "Uncertainty about expectations",
      "Differences in values or goals",
      "Pressure to 'get it right'",
      "Adjusting to new roles together",
    ],
    help: [
      "Exploring values, goals, and expectations",
      "Strengthening communication early",
      "Building effective conflict-resolution skills",
      "Support adapting to married life",
    ],
    outcome:
      "Clarity, compatibility, and a strong foundation for the road ahead.",
    outcomeImg:
      "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=1600&auto=format&fit=crop&q=80",
  },
  "domestic-violence": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1518398046578-8cca57782e17?w=1600&auto=format&fit=crop&q=80",
    intro:
      "A safe, confidential space for those experiencing or recovering from abuse — at your own pace, on your own terms.",
    feel: [
      "Fear or ongoing distress",
      "Loss of self-worth",
    ...
    help: [
      ...
      "Developing safety and coping strategies",
  ...
  career: {
    ...
    intro:
      "Career decisions shape so much of life. We help you choose with clarity instead of pressure.",
    feel: [
      "Uncertainty about direction",
      "Pressure from outside expectations",
      "Difficulty identifying strengths",
      "Fear of making the wrong choice",
    ],
    help: [
      "Understanding your strengths and interests",
      "Mapping out realistic paths forward",
    ...
    outcomeImg:
      "https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?w=1600&auto=format&fit=crop&q=80",
  },
  motivation: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?w=1600&auto=format&fit=crop&q=80",
    intro:
      "When direction feels lost, we help you reconnect with purpose and take meaningful, consistent action.",
    feel: [
    ...
    help: [
      "Identifying personal barriers and goals",
      "Building consistency and structure",
      "Reconnecting with your 'why'",
      "Practical, sustainable action steps",
    ],
  ...
  "time-management": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Time feels limited when there's no structure around it. We help you build a rhythm that actually works for you.",
    feel: [
      "Constant sense of overload",
      "Difficulty prioritising tasks",
      "Procrastination under pressure",
      "Stress from feeling perpetually behind",
    ],
    help: [
  ...
  "work-life-balance": {
    ...
    ...base.career,
    heroImg:
      "https://images.unsplash.com/photo-1483389127117-b6a2102724ae?w=1600&auto=format&fit=crop&q=80",
    intro:
      "When work and life blur together, everything suffers. We help you build sustainable structure and boundaries.",
    feel: [
      "Constant overload and burnout creeping in",
      "Guilt around rest or downtime",
      "Strained personal relationships",
      "Loss of personal time and identity",
    ],
    help: [
      "Mapping routines and responsibilities",
      "Practical boundary-setting techniques",
      "Balancing productivity with well-being",
      "Sustainable, realistic daily structure",
    ],
  ...
  adolescent: {
    ...
    group: "Children & Family",
    ...base.family,
    heroImg:
      "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Growing up brings real emotional weight. We help teenagers navigate it with confidence, clarity, and self-awareness.",
    feel: [
  ...
  parenting: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Parenting today can feel overwhelming. We offer practical, compassionate guidance for the everyday challenges you face.",
    feel: [
      "Difficulty managing behaviour",
      "Communication gaps with your child",
      "Parenting stress and overwhelm",
      "Uncertainty about boundaries and discipline",
    ],
    help: [
      "Practical, realistic parenting strategies",
      "Mindful communication techniques",
      "Consistency without rigidity",
      "Boundaries grounded in empathy and care",
    ],
  ...
  family: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1511895307984-ee87c1cf0bc6?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Every family faces friction — what matters is how you move through it together.",
    feel: [
      "Communication gaps between members",
      "Recurring conflict within the family",
      "Emotional distance",
      "Difficulty adjusting to life changes",
    ],
    help: [
      "A space where every voice is heard",
      "Rebuilding trust as a unit",
  ...
  "academic-support": {
    ...
    feel: [
      ...
      "Stress around exams or performance",
    ],
    help: [
      "Techniques for better recall and revision",
      "Understanding concepts over memorising",
      "Healthy, sustainable study habits",
      "Stress reduction around academics",
    ],
  ...
  /* ════════ SPECIALISED SUPPORT ════════ */
  trauma: {
    title: "Trauma & PTSD Counselling",
    group: "Specialised Support",
    ...base.specialised,
    heroImg:
      "https://images.unsplash.com/photo-1500964757637-c85e8a162699?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Traumatic experiences can stay with the body long after the moment has passed. Healing is possible, at your pace.",
    feel: [
    ...
    help: [
      "A safe space to process at your own pace",
  ...
  adhd: {
    ...
    intro:
      "ADHD affects focus, structure, and daily rhythm. We take a strengths-based approach to help you build what works for you.",
    feel: [
      "Difficulty with focus or task completion",
      "Impulsivity or restlessness",
      "Struggles with organisation and routine",
      "Self-esteem affected by performance",
    ],
    help: [
      "Strengths-based, compassionate strategies",
      "Building structure and routine",
      "Tools for focus and follow-through",
      "Support for academic or workplace challenges",
    ],
  ...
  grief: {
    ...
    feel: [
      ...
      "Anger or bargaining",
      "Deep sadness or withdrawal",
      "Slowly finding moments of peace",
    ],
    help: [
      "A safe, understanding space",
      "Help processing complex emotions",
      "Finding meaning at your own pace",
      "Support that honours your timeline",
    ],
  ...
  lgbtq: {
    title: "LGBTQIA+ Affirmative Counselling",
    group: "Specialised Support",
    ...base.specialised,
    heroImg:
      "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1600&auto=format&fit=crop&q=80",
    intro:
      "A safe, inclusive, non-judgmental space to explore identity, relationships, and life — fully affirmed.",
    feel: [
      "Navigating identity or coming out",
      "Lack of understanding from others",
      "Anxiety around acceptance",
      "Seeking community and validation",
    ],
    help: [
      "Affirmative, judgment-free support",
      "Building self-acceptance and resilience",
      "Navigating relationships and family dynamics",
      "A space that honours your lived experience",
    ],
  ...
  addiction: {
    title: "Addiction & De-Addiction Counselling",
    group: "Specialised Support",
    ...base.specialised,
    heroImg:
      "https://images.unsplash.com/photo-1518131672697-613becd4fab5?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Addiction affects every part of life. We provide a confidential, supportive path toward lasting recovery.",
    feel: [
      "Loss of control over dependency",
      "Strained relationships",
      "Shame or isolation",
      "Cycles that feel hard to break",
    ],
    help: [
      "Understanding underlying emotional causes",
  ...
  "anger-management": {
    ...
    group: "Emotional & Behavioural",
    ...base.emotional,
    heroImg:
      "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Anger is a natural emotion — but when it controls you, it harms relationships and well-being. We help you understand it and respond differently.",
    feel: [
      "Frequent or intense outbursts",
      "Difficulty calming down after conflict",
      "Regret following reactions",
      "Feeling misunderstood by others",
    ],
    help: [
      "Identifying triggers and underlying causes",
      "Practical strategies to respond calmly",
      "Emotional regulation techniques",
      "Building healthier communication patterns",
    ],
    outcome:
      "Emotional balance, calmer responses, and healthier relationships.",
    outcomeImg:
      "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1600&auto=format&fit=crop&q=80",
  },
  "panic-attack": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Panic attacks can feel terrifying and uncontrollable. We help you understand them — and build the tools to face them.",
    feel: [
      "Sudden overwhelming fear or dread",
      "Physical symptoms — racing heart, breathlessness",
  ...
  bipolar: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Bipolar disorder brings intense highs and lows. We help you recognise patterns and build a more stable, consistent life.",
    feel: [
      "Unpredictable mood swings",
      "Difficulty maintaining relationships and routines",
      "Periods of very high or very low energy",
      "Feeling misunderstood by those around you",
    ],
    help: [
      "Recognising early warning signs",
      "Building structure and consistent routines",
  ...
  "low-self-esteem": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=1600&auto=format&fit=crop&q=80",
    intro:
      "When self-doubt shapes how you see yourself, it affects every area of life. We help you rebuild from the inside out.",
    feel: [
      "Self-doubt and negative self-talk",
      "Lack of confidence personally or professionally",
      "Fear of failure or judgment",
      "Feelings of inadequacy or comparison",
    ],
    help: [
      "Building a healthier, more accurate self-image",
      "Strengthening inner resilience",
      "Challenging and reframing self-critical thoughts",
      "Practical steps toward greater self-worth",
    ],
  ...
  "negative-thinking": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Persistent self-critical thoughts can distort reality and drain your energy. We help shift perspective in a lasting way.",
    feel: [
      "Self-critical inner dialogue",
      "A tendency to expect the worst",
      "Difficulty accepting positives",
      "Mental exhaustion from constant negativity",
    ],
    help: [
      "Awareness and identification of thought patterns",
  ...
  behavioural: {
    ...
    intro:
      "Unhelpful behaviour patterns can feel automatic. We help you understand them — and replace them with healthier responses.",
    feel: [
      "Negative habits that are hard to break",
      "Difficulty with self-control or impulse",
      "Stress-triggered behavioural patterns",
      "Social or interpersonal challenges",
    ],
    help: [
      "Understanding the roots of behaviour",
      "Structured strategies for lasting change",
      "Building healthier responses to triggers",
      "Support for consistency and motivation",
    ],
  ...
  bullying: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Bullying leaves real emotional marks. We help you rebuild confidence, safety, and inner resilience.",
    feel: [
      "Damaged confidence and self-worth",
      "Anxiety in social situations",
      "Withdrawal from activities",
      "Feeling unsafe or targeted",
    ],
    help: [
      "A safe, supportive space to process experiences",
  ...
  phobia: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Phobias can quietly shrink the world around you. We use gradual, evidence-based techniques to help you face and reduce fear.",
    feel: [
      "Intense fear around specific triggers",
      "Avoidance limiting daily life",
      "Physical symptoms of anxiety",
      "Distress even anticipating the trigger",
    ],
    help: [
      "Gradual, structured exposure techniques",
  ...
  individual: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=1600&auto=format&fit=crop&q=80",
    intro:
      "A confidential, one-to-one space to explore what you're carrying — and find your way forward with clarity.",
    feel: [
      "A need to talk without judgment",
    ...
    help: [
      "Confidential, personalised support",
  ...
  couples: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1518621012420-8ab10887ea36?w=1600&auto=format&fit=crop&q=80",
    intro:
      "A collaborative space where partners can explore concerns honestly and strengthen their connection.",
    feel: [
    ...
    outcome:
      "Relationship satisfaction, stability, and long-term emotional closeness.",
    outcomeImg:
      "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=1600&auto=format&fit=crop&q=80",
  },
  divorce: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1494774157365-9e04c6720e47?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Navigating divorce is emotionally and practically complex. We offer a confidential space to process it with clarity.",
    feel: [
      "Complex grief and emotional loss",
      "Difficulty making clear decisions",
      "Conflict around separation logistics",
      "Fear about what comes next",
    ],
    help: [
      "Processing complex emotions safely",
      "Support making thoughtful, informed decisions",
  ...
  "sex-counselling": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=1600&auto=format&fit=crop&q=80",
    intro:
      "A safe, respectful space to discuss intimacy and sexual well-being — openly and without judgment.",
    feel: [
      "Concerns around intimacy or desire",
      "Communication difficulties with a partner",
      "Anxiety or discomfort around sexuality",
      "Questions about needs and identity",
    ],
    help: [
      "Evidence-based, respectful guidance",
  ...
  "suicidal-intervention": {
    ...
    feel: [
      ...
      "A sense that nothing will get better",
    ],
    help: [
      "Immediate, non-judgmental support",
      "Reducing emotional distress and restoring hope",
      "Safe space to be fully heard",
      "Extended support for families and caregivers",
    ],
  ...
  psychodynamic: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Understanding deep emotional patterns from your past can unlock lasting change in your present.",
    feel: [
      "Long-standing emotional difficulties",
      "Patterns that repeat across relationships",
      "Unresolved feelings from the past",
      "A sense of not fully understanding yourself",
    ],
    help: [
      "Exploring past experiences and their influence",
      "Awareness of unconscious feelings and conflicts",
      "Resolving deep-rooted emotional difficulties",
      "A thoughtful, exploratory approach to healing",
    ],
  ...
  "psychometric-testing": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Scientifically designed tools to understand your abilities, personality, and behaviour — with clarity and insight.",
    feel: [
      "Uncertainty about your own strengths",
      "Questions about personality or behaviour patterns",
      "Need for evidence-based self-understanding",
      "Seeking clarity for academic or career decisions",
    ],
    help: [
      "Scientifically validated assessments",
      "Clear, actionable insights about abilities and traits",
      "Understanding emotional functioning",
      "Support for personal, academic, and professional growth",
    ],
    outcome:
      "Clarity, self-knowledge, and informed decisions about your future.",
    outcomeImg:
      "https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?w=1600&auto=format&fit=crop&q=80",
  },
  "learning-disability": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Dyslexia, dysgraphia, dyscalculia and more — we help children build confidence and personalised strategies to thrive.",
    feel: [
      "Academic struggles despite effort",
      "Frustration with reading, writing, or numbers",
      "Low confidence linked to performance",
      "Feeling different from peers",
    ],
    help: [
      "Personalised, tailored learning strategies",
      "Building confidence and self-efficacy",
      "Improving learning skills and coping mechanisms",
      "Support for emotional well-being alongside academics",
    ],
  ...
  abandonment: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Feelings of rejection and abandonment can shape how you see yourself and relate to others. Healing is possible.",
    feel: [
      "Deep fear of being left or rejected",
      "Difficulty trusting others",
      "Low emotional security in relationships",
      "Patterns linked to childhood experiences",
    ],
    help: [
      "Compassionate space to explore the roots",
  ...
  "eating-disorders": {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Eating disorders are complex and deeply personal. We offer compassionate support to understand patterns and build a healthier relationship with food.",
    feel: [
      "Unhealthy or restrictive food patterns",
      "Emotional triggers around eating",
      "Distorted body image",
      "Guilt or shame around food and weight",
    ],
    help: [
      "Understanding patterns, thoughts, and triggers",
  ...
  personality: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Understanding your personality — your traits, patterns, and dynamics — unlocks meaningful personal development.",
    feel: [
      "Confusion about recurring behavioural patterns",
      "Interpersonal difficulties",
      "Uncertainty about your own identity",
      "A desire for deeper self-understanding",
    ],
    help: [
      "Exploring traits and behavioural patterns",
      "Understanding interpersonal dynamics",
      "Developing skills to navigate challenges",
      "Enhancing natural strengths and managing difficulties",
    ],
  ...
  education: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Choosing the right educational path can feel daunting. We help students make informed, confident decisions.",
    feel: [
      "Uncertainty about courses or learning paths",
      "Pressure from family or expectations",
      "Difficulty identifying strengths or interests",
      "Fear of making the wrong academic choice",
    ],
    help: [
      "Understanding interests, strengths, and goals",
      "Clarity on suitable courses and pathways",
      "Building confidence in academic decisions",
      "Support for academic success and adjustment",
    ],
  ...
  menopause: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Menopause brings significant emotional, physical, and lifestyle shifts. We offer compassionate support through every stage.",
    feel: [
      "Mood changes and emotional volatility",
      "Physical discomfort and fatigue",
      "Loss of confidence or identity shifts",
      "Uncertainty about what's happening to your body",
    ],
    help: [
      "Understanding emotional and physical changes",
  ...
  dementia: {
    ...
    ...base.care,
    heroImg:
      "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Structured, compassionate support for individuals with Alzheimer's or dementia — and for the caregivers who love them.",
    feel: [
      "Memory decline and cognitive change",
      "Emotional distress and confusion",
      "Caregiver stress and exhaustion",
      "Uncertainty about what lies ahead",
    ],
    help: [
      "Evidence-informed strategies for daily management",
      "Communication support for individuals and families",
      "Caregiver guidance and emotional support",
      "Promoting safety, consistency, and quality of life",
    ],
  ...
  eap: {
    ...
    heroImg:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1600&auto=format&fit=crop&q=80",
    intro:
      "Confidential support for personal and work-related challenges — helping employees thrive inside and outside the workplace.",
    feel: [
    ...
    help: [
      ...
      "Support for workplace and personal challenges",
      "Tools for improved emotional well-being",
    ],
...
export default async function ServiceDetail({ params }: Props) {
  ...
  const d = data[slug as keyof typeof data] ?? data.depression;
  ...
  return (
    <>
      ...
      <div
        className="sd-page"
        style={{ background: T.bgMain, color: T.textMain, marginTop: 80 }}
      >
        {/* ════════ HERO ════════ */}
        <section
          style={{
          ...
          <div style={{ position: "absolute", inset: 0 }}>
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `linear-gradient(to top, ${T.bgDark} 5%, rgba(16,16,18,0.45) 45%, rgba(16,16,18,0.75) 100%)`,
              }}
            />
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `radial-gradient(ellipse at 20% 30%, ${d.accent}33, transparent 60%)`,
              }}
            />
          </div>

          <div
            className="sd-hero-nav"
            style={{
              position: "absolute",
              top: 32,
              left: 0,
        ...
        >
          <Reveal>
            ...
            >
              ...
              <em style={{ color: d.accent }}>and how we help.</em>
            </h2>
          </Reveal>

          <div
            className="sd-feel-help-grid"
        ...
        >
          <div style={{ position: "absolute", inset: 0 }}>
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `linear-gradient(to bottom, ${T.bgDark} 0%, rgba(16,16,18,0.55) 40%, ${T.bgDark} 100%)`,
              }}
            />
          </div>
          ...
          >
            <div
              className="sd-orbit-ring"
              style={{ width: 520, height: 520, top: -260, left: -260 }}
            />
            <div
              className="sd-orbit-ring"
              style={{
          ...
          >
            ...
            <Reveal delay={200}>
              <Link
                href="/book"
                className="sd-cta-pill"
                style={{ background: "#fff", color: T.bgDark }}
              >
                Book a session
                <span
                  style={{
